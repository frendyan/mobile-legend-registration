			...
			<div class="row" >
				...
				<div class="col-md-6">
					...
					<div class="card">
						...
						<!-- /.card-header -->
						<!-- form start -->
						<form action="{{ route('saveSecondTest') }}" method="POST" enctype="multipart/form-data">
							@csrf                
							<div class="card-body">
								...
								<div class="form-group">
									...
									<div class="form-group">
										<div class="custom-control custom-checkbox">
											<input class="custom-control-input" type="checkbox" name="key[]" id="customCheckbox1" value="a">
											<label for="customCheckbox1" class="custom-control-label">A</label>
										</div>
										<div class="custom-control custom-checkbox">
											<input class="custom-control-input" type="checkbox" name="key[]" id="customCheckbox2" value="b">
											<label for="customCheckbox2" class="custom-control-label">B</label>
										</div>
										<div class="custom-control custom-checkbox">
											<input class="custom-control-input" type="checkbox" name="key[]" id="customCheckbox3" value="c">
											<label for="customCheckbox3" class="custom-control-label">C</label>
										</div>
										<div class="custom-control custom-checkbox">
											<input class="custom-control-input" type="checkbox" name="key[]" id="customCheckbox4" value="d">
											<label for="customCheckbox4" class="custom-control-label">D</label>
										</div>
										<div class="custom-control custom-checkbox">
											<input class="custom-control-input" type="checkbox" name="key[]" id="customCheckbox5" value="e">
